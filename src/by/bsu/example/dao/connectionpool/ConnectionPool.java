package by.bsu.example.dao.connectionpool;
...
import by.bsu.example.manager.DBResourceManager;
import by.bsu.example.manager.DBParameter;
...
public final class ConnectionPool {
    ...
    private ConnectionPool() {
        ...
        try {
            ...
            logger.error("initPoolData error! " + e.getMessage());
        }
    }
    ...
    protected void initPoolData() throws ConnectionPoolException {
    ...
    public Connection takeConnection() throws ConnectionPoolException {
        ...
        try {
            ...
            throw new ConnectionPoolException(
                    "Error connecting to the entity source.", e);
        }
        return connection;
    }
